...
if($resultado->rowCount() > 0){
    $tabla .= "<table class='shadow-lg bg-white table-fixed'>
                    <th >
                        <tr>
                            <td class='bg-blue-100 border text-center w-1/2 px-8 py-2'>Nombre</td>
                            <td class='bg-blue-100 border text-center w-1/2 px-8 py-2'>Cantidad de Dosis</td>
    ...
    foreach ($conexion->query($query) as $fila) {
        $tabla .= " <tr>
                        ...
                        <td class='text-center border border-gray-300 p-1'>".$fila['dosis']."</td>
