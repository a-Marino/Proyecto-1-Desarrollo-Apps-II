    ...
    <div class="flex items-center justify-center py-4 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <button class="relative w-full flex justify-center text-xs text-gray-500 mt-5 py-2" name="boton" value="restablecer" formnovalidate> Olvide mi Contraseña  </button>
            </div>
        </div>
    </div>
    </div>