<div class="relative min-h-screen flex m-0 p-0">
	...
	<div class="bg-gray-200 w-56">
		...
		<nav class="flex flex-col items-center h-screen">
			...
			<div class="mt-auto">
				<button class="w-28 py-2 5 px-4 m-auto mt-4 hover:bg-gray-400" name="boton" value="logout" formnovalidate=""><img src="imagenes/cerrar.png" class="w-16 m-auto"></button>
			</div>
		</nav>
	</div>
