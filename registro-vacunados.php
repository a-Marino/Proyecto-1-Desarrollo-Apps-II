	...
	<div id="form-reg-vacunacion">
		<form action="" method="" class="px-4 my-10 max-w-3xl mx-24 space-y-5">
			...
			<div class="flex justify-between">
				...
				<button id="btn_volver_menu" type="button" class="px-2">
			...
			<div class="flex space-x-4">
				...
				<div class="w-1/2">
					<label for="id_vacunatorio2">Vacunatorio segunda dosis</label>
					<select name="id_vacunatorio2" id="id_vacunatorio2" class="border border-gray-400 block py-2 px-4 rounded w-full" required>
						<!-- Cambiar estas opciones una vez este la base de datos y todo conectado !-->
						<option value="id1">Vacunatorio 1</option>
						<option value="id2">Vacunatorio 2</option>
						<option value="id3">Vacunatorio 3</option>
